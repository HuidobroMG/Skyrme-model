...
We plot the baryon density of a Skyrme field configuration following the Leed's colouring convention, 
for which we need the Skyrme fields.
For the 3-dimensional representation and the colouring we use the Mayavi module of Python.
"""
