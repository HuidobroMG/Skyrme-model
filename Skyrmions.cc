...
double LeviCivita(int i, int j, int k, int l)
{
	...
	return 0;
      ...
      {
	double eps = static_cast<double>((i-j)*(i-k)*(i-l)*(j-k)*(j-l)*(k-l))/12.;
	return eps;
      }
}
